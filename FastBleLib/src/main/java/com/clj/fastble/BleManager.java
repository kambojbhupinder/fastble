...
public class BleManager {
    ...
    public void scan(BleScanCallback callback) {
        ...
        Log.e("serviceUuids length", bleScanRuleConfig.getServiceUuids() + "");
        Log.e("deviceNames length", bleScanRuleConfig.getDeviceNames() + "");
//        Log.e("serviceUuids", serviceUuids[0] + "");
//        Log.e("deviceNames", deviceNames[0] + "");
        Log.e("deviceMac", deviceMac + "");
        Log.e("fuzzy", bleScanRuleConfig.isFuzzy() + "");
        Log.e("timeOut", bleScanRuleConfig.getScanTimeOut() + "");
        //deviceMac = "F4:BF:80:5B:7E:DC";
        Log.e("deviceMac", deviceMac + "");
        //Log.e("deviceMac",bleScanRuleConfig+"");
     ...
     * @return
     */
    public boolean isSupportBle() throws Exception {
        if (context == null) {
            throw new Exception("conetxt has been recycled");
        }
